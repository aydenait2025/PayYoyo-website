          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                title: 'GPS-Enhanced Intelligence',
                description: 'Location-aware AI considers proximity to merchants, current promotions, and historical spending data to make optimal payment decisions.'
              },
              {
                icon: (
                  <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: 'Eliminates $364B in global gift card waste by ensuring every dollar is optimally utilized through intelligent redistribution.'
              },
              {
                icon: (
                  <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: 'PCI DSS Level 1 compliance with end-to-end encryption, ensuring your financial data is protected by enterprise-grade security measures.'
              },
              {
                icon: (
                  <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: 'AI continuously monitors market conditions and adjusts payment strategies in real-time for maximum savings and efficiency.'
              },
              {
                icon: (
                  <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                description: 'Machine learning algorithms predict future spending patterns and optimize gift card utilization before expiration.'
              }
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
