      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <ul className="space-y-2">
                {['Features', 'Security', 'API', 'Pricing'].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-gray-600 hover:text-[#1E40AF] transition-colors duration-200 text-sm">
                      {item}
                    </a>
                  </li>
                ))}
        ...
        >
          <p className="text-gray-500 text-sm">
            © 2025 Paybubu. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-[#1E40AF] transition-colors duration-200">
